...
export function MicOffIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M9 9v3a3 3 0 004.9 2.3M15 6.3V5a3 3 0 00-5.8-1.2" />
      <path d="M5 11a7 7 0 0010.3 6.2M12 18v4M8 22h8" />
      <path d="M3 3l18 18" />
    </svg>
  );
}
...
export function BellIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M18 8a6 6 0 00-12 0c0 4-2 5-2 7h16c0-2-2-3-2-7z" />
...
export function HelpCircleIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9.5 9a2.5 2.5 0 114.3 1.8c-.7.7-1.8 1-1.8 2.4" />
      <path d="M12 17.5h.01" />
    </svg>
  );
}
...
export function CameraIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M4 8h3l2-2h6l2 2h3v11a1 1 0 01-1 1H5a1 1 0 01-1-1V8z" />
...
export function EndCallIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M2.5 9.5C7 5 17 5 21.5 9.5l-3.2 3.2c-.6.6-1.6.6-2.2-.1l-1-1.2a1.6 1.6 0 00-2 0c-1 .8-2.4 2.2-3.2 3.2a1.6 1.6 0 000 2l1.2 1c.7.6.7 1.6.1 2.2L8 23C3.5 18.5 3.5 14 2.5 9.5z" />
    </svg>
  );
}
...
export function PinIcon({ size = 14, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M14.5 2.5l7 7-3.5 3.5-1-1-4 4 1 5-2 2-4-4-5 5-1-1 5-5-4-4 2-2 5 1 4-4-1-1z" />
    </svg>
  );
}
