...
export function PaletteIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 3a9 8 0 100 16c1.5 0 1.8-1 1.2-1.8-.6-.8-.3-1.9 1-1.9H16a4 4 0 004-4c0-4.5-3.6-8.3-8-8.3z" />
...
export function CubeIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 22V11.5M4 6.5l8 5 8-5" />
    </svg>
  );
}
...
export function CoffeeIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M17 10h1.5a2.5 2.5 0 010 5H17M8 3c-.5.7-.5 1.3 0 2M12 3c-.5.7-.5 1.3 0 2" />
    </svg>
  );
}
...
export function VolumeIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M17 8a5 5 0 010 8M19.5 5.5a8.5 8.5 0 010 13" />
    </svg>
  );
}
